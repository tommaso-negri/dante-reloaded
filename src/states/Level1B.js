...
export default class Level1 extends Phaser.State {
  ...
  preload() {
    ...
    // // PARALLAX BGs
    // game.load.image('level1BG1A', 'assets/tilemaps/level1/BGs/BG1/sfondo_4.png')
    // game.load.image('level1BG1B', 'assets/tilemaps/level1/BGs/BG1/sfondo_3.png')
    // game.load.image('level1BG1C', 'assets/tilemaps/level1/BGs/BG1/sfondo_2.png')
    // game.load.image('level1BG1D', 'assets/tilemaps/level1/BGs/BG1/sfondo_1.png')
  ...
  create() {
    ...
    //     this.game.cache.getImage('level1BG1A').width,
    //     this.game.cache.getImage('level1BG1A').height,
    //     'level1BG1'
    // );
    // this.parallax2 = this.game.add.tileSprite(0,
    //   this.game.height - 568,
    //     this.game.cache.getImage('level1BG1B').width,
    //     this.game.cache.getImage('level1BG1B').height,
    //     'level1BG2'
    // );
    // this.parallax3 = this.game.add.tileSprite(0,
    //   this.game.height - 568,
    //     this.game.cache.getImage('level1BG1C').width,
    //     this.game.cache.getImage('level1BG1C').height,
    //     'level1BG3'
    // );
    // this.parallax4 = this.game.add.tileSprite(0,
    //   this.game.height - 568,
    //     this.game.cache.getImage('level1BG1D').width,
    //     this.game.cache.getImage('level1BG1D').height,
    //     'level1BG4'
    // );
    ...
    this.parallax1 = this.game.add.tileSprite(0,
        this.game.height - this.game.cache.getImage('level1BG1A').height,
        this.game.width,
        this.game.cache.getImage('level1BG1A').height,
        'level1BG1A'
    );
    this.parallax2 = this.game.add.tileSprite(0,
        this.game.height - this.game.cache.getImage('level1BG1B').height,
        this.game.width,
        this.game.cache.getImage('level1BG1B').height,
        'level1BG1B'
    );
    this.parallax3 = this.game.add.tileSprite(0,
        this.game.height - this.game.cache.getImage('level1BG1C').height,
        this.game.width,
        this.game.cache.getImage('level1BG1C').height,
        'level1BG1C'
    );
    this.parallax4 = this.game.add.tileSprite(0,
        this.game.height - this.game.cache.getImage('level1BG1D').height,
        this.game.width,
        this.game.cache.getImage('level1BG1D').height,
        'level1BG1D'
    );
    ...
    map.addTilesetImage('TestTiles', 'level1Tileset')
